...
module.exports = () => {
    ...
    store.io.sockets
        ...
        .on('authenticated', socket => {
            ...
            socket.on('disconnect', () => {
                ...
                User.findOneAndUpdate({_id: id}, {$set: {lastOnline: Date.now()}}).then(() => console.log('last online ' + id)).catch(err => console.log(err));
    ...
    const mongooseConnect = () => {
        ...
        mongoose.connect(store.config.db, {
